...
def register_robotics_envs():
    ...
    for reward_type in ["sparse", "dense"]:
        ...
        # Discrete variants of FetchPickAndPlace
        register(
            id=f"FetchPickAndPlaceDiscrete{suffix}-v4",
            entry_point="gymnasium_robotics.envs.fetch.pick_and_place_discrete:MujocoFetchPickAndPlaceDiscreteEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )
        register(
            id=f"FetchPickAndPlaceDiscrete{suffix}-v1",
            entry_point="gymnasium_robotics.envs.fetch.pick_and_place_discrete:MujocoPyFetchPickAndPlaceDiscreteEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )
        ...
        # Discrete variants of FetchReach
        register(
            id=f"FetchReachDiscrete{suffix}-v4",
            entry_point="gymnasium_robotics.envs.fetch.reach_discrete:MujocoFetchReachDiscreteEnv",
            kwargs=kwargs,
            max_episode_steps=50,
        )

    # VLM-Gym custom Fetch environment registrations (difficulty-based IDs)
    register(
