...
gsutil -m cp -r gs://viscam-team-bucket-hns/junyizhang/Code/Notebooks/gym/models/mixed_all_v5_300k_norefdot/checkpoint-4500 /dev/shm/
...
### model
model_name_or_path: /dev/shm/checkpoint-4500
